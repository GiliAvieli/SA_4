        ...
        BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    INSERT INTO EquipmentIssue (equipmentissue_id, equipmentId, reservationId, reservation_detail_id, issued_qty, returned_ok_qty, lost_qty, damaged_qty, status, issueDate)
                    VALUES (@NextIssueId, @EquipmentId, @equipmentreservation_id, @ReservationDetailId, @DeliveredQty, 0, 0, 0, 'Active', GETDATE());
